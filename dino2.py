...
# Pastikan jalur font benar
game_font = pygame.font.Font("C:/Users/PSC/Documents/DINO 2/PressStart2P-Regular.ttf", 24)
...
class Dino(pygame.sprite.Sprite):
    def __init__(self, x_pos, y_pos):
        ...
        self.running_sprites.append(
            pygame.transform.scale(pygame.image.load("C:/Users/PSC/Documents/DINO 2/Dino1.png"), (80, 100)))
        self.running_sprites.append(
            pygame.transform.scale(pygame.image.load("C:/Users/PSC/Documents/DINO 2/Dino2.png"), (80, 100)))
        self.ducking_sprites.append(
            pygame.transform.scale(pygame.image.load("C:/Users/PSC/Documents/DINO 2/DinoDucking1.png"), (110, 60)))
        self.ducking_sprites.append(
            pygame.transform.scale(pygame.image.load("C:/Users/PSC/Documents/DINO 2/DinoDucking2.png"), (110, 60)))
        self.x_pos = x_pos
        self.y_pos = y_pos
    ...
    def jump(self):
        ...
        if self.rect.centery >= 360:
            while self.rect.centery - self.velocity > 45:
                self.rect.centery -= 1
    ...
    def __init__(self, x_pos, y_pos):
        ...
        for i in range(1, 7):
            current_sprite = pygame.transform.scale(
                pygame.image.load(f"C:/Users/PSC/Documents/DINO 2/cacti/cactus{i}.png"), (100, 100))
...
class Ptero(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.sprites = []
        self.sprites.append(
            pygame.transform.scale(pygame.image.load("C:/Users/PSC/Documents/DINO 2/Ptero1.png"), (84, 62)))
        self.sprites.append(
            pygame.transform.scale(pygame.image.load("C:/Users/PSC/Documents/DINO 2/Ptero2.png"), (84, 62)))
        self.current_image = 0
...
# Surfaces
ground = pygame.image.load("C:/Users/PSC/Documents/DINO 2/ground.png")
ground = pygame.transform.scale(ground, (1280, 20))
ground_x = 0
ground_rect = ground.get_rect(center=(640, 400))
cloud = pygame.image.load("C:/Users/PSC/Documents/DINO 2/cloud.png")
...
# Sounds
death_sfx = pygame.mixer.Sound("C:/Users/PSC/Documents/DINO 2/sfx/lose.mp3")
points_sfx = pygame.mixer.Sound("C:/Users/PSC/Documents/DINO 2/sfx/100points.mp3")
jump_sfx = pygame.mixer.Sound("C:/Users/PSC/Documents/DINO 2/sfx/jump.mp3")
